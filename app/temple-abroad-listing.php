...
<div class="card-header position-relative">
    <div class="d-flex justify-content-between align-items-center flex-wrap">
        <div>
            <h6 class="fs-17 fw-semi-bold my-1">Temples in Abroad</h6>
        ...
        <div class="card">
            <div class="card-body">
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        <?php $select = "SELECT * FROM `abroad` WHERE index_id!='0' ORDER BY index_id DESC";
    ...
    $.ajax({
        ...
        success: function (responseText) {
            ...
            try {
                ...
                toastr.error("An error occurred: Invalid server response.");
            }
        },
        error: function (xhr, status, error) {
            console.error("AJAX Error:", error);
            toastr.error("An error occurred: " + (xhr.responseText || "Unknown error"));
        },
    });
});
